...
SC_MODULE(testbench)
{
	...
	void test()
	{
		...
		while(true){
			...
			wait(9, SC_NS);
			cout << "[ " << sc_time_stamp() << " ] Changing timer_cmp value" << endl;
			addr.write(TIMER_CMP);
			data_in.write(100);
			write_en.write(1);
			wait(1, SC_NS);
...
Output:
        ...
        SystemC 2.3.1-Accellera --- May 13 2017 07:15:05
        Copyright (c) 1996-2014 by all Contributors,
        ALL RIGHTS RESERVED
Interrupt asserted: Intr1 ( 2660 ns )
Interrupt asserted: Intr0 ( 5080 ns )
Interrupt asserted: Intr1 ( 7780 ns )
Interrupt asserted: Intr0 ( 10200 ns )
Interrupt asserted: Intr1 ( 12900 ns )
Interrupt asserted: Intr0 ( 15320 ns )
Interrupt asserted: Intr1 ( 18020 ns )
[ 18471 ns ] 157
[ 19991 ns ] 233
[ 20 us ] Disable timer
[ 20501 ns ] 234
[ 21 us ] Enable timer
Interrupt asserted: Intr0 ( 21440 ns )
Interrupt asserted: Intr1 ( 24140 ns )
Interrupt asserted: Intr0 ( 26560 ns )
Interrupt asserted: Intr1 ( 29260 ns )
[ 29991 ns ] 171
[ 30 us ] Changing timer_cmp value
Interrupt asserted: Intr0 ( 31680 ns )
Interrupt asserted: Intr1 ( 33680 ns )
Interrupt asserted: Intr0 ( 36800 ns )
Interrupt asserted: Intr1 ( 38800 ns )
[ 40 us ] Turn off interrupt asserted messages
[ 1 ms ] Turn on interrupt asserted messages
[ 1000751 ns ] 69
Interrupt asserted: Intr1 ( 1001360 ns )
Interrupt asserted: Intr0 ( 1004480 ns )
Interrupt asserted: Intr1 ( 1006480 ns )
Interrupt asserted: Intr0 ( 1009600 ns )
